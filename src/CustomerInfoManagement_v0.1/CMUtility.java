...
public class CMUtility {
    ...
    /**
     * Return the character got from keyboard.
     * 
     * @param defaultValue the default value
     * @return the character
     */
    public static char getChar(char defaultValue) {
    ...
    /**
     * Return the integer got from the keyboard.
     * 
     * @param defaultValue the default value
     * @return the integer
     */
    ...
    /**
     * Return the string got from keyboard.
     * 
     * @param limit the limit of string's length
     * @return the string
     */
    public static String getString(int limit) {
     ...
     * @return the string
     */
    public static String getString(int limit, String defaultValue) {
